...
;    airtovac: in, optional, type=byte
...
;      Set the pixels of wavelengths covering the [OI] glow to carry high
;      variance values so that their weights for fitting are low.
; :Author:
;    David S. N. Rupke::
;      Rhodes College
...
;      2019nov08, MWL,  added airtovac, helio, and mskOI keywords
;    
; :Copyright:
